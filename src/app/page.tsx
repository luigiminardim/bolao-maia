...
export default function Home() {
  ...
  const handleCreatePool = (e: React.FormEvent) => {
    ...
    setAlertMessage(
      `Bolão "${newPoolName}" criado com sucesso! Compartilhe o código de convite: MAIA-${Math.floor(1000 + Math.random() * 9000)}`,
    );
  ...
  const updateScore = (matchId: string, team: "home" | "away", val: number) => {
    setMatches((prev) =>
      prev.map((m) => {
        if (m.id === matchId) {
          const currentVal =
            parseInt(team === "home" ? m.predictionHome : m.predictionAway) ||
            0;
    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 font-sans text-zinc-100 antialiased selection:bg-emerald-500/20 selection:text-emerald-400">
      ...
      <header className="sticky top-0 z-40 w-full border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Chip
              color="success"
              className="text-[10px] h-5 px-1.5 font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
            >
              v3.0 (HeroUI)
            </Chip>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-zinc-400">
            <span className="text-zinc-100 border-b-2 border-emerald-500 pb-1 pt-1 px-1">
              Painel
            </span>
            <a href="#pools" className="hover:text-zinc-100 transition-colors">
              Meus Bolões
            </a>
            <a
              href="#leaderboard"
            ...
            <a href="#rules" className="hover:text-zinc-100 transition-colors">
              Regulamento
            </a>
          </nav>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 border-l border-zinc-800 pl-4">
              <Avatar
                ...
                className="size-8 ring-2 ring-emerald-500/20"
              >
                <Avatar.Image
      ...
      {alertMessage && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-50 w-full max-w-xl px-4 animate-in fade-in slide-in-from-top duration-300">
          <Alert
            status="success"
            className="bg-zinc-900 border border-emerald-500/30 text-zinc-100 shadow-xl shadow-black/80"
          >
            <Alert.Indicator className="text-emerald-500" />
            <Alert.Content>
              <Alert.Title className="font-semibold text-emerald-400">
                Sucesso!
              </Alert.Title>
              <Alert.Description className="text-zinc-300 text-sm mt-0.5">
                {alertMessage}
              </Alert.Description>
            </Alert.Content>
            <CloseButton
          ...
          <Card className="relative w-full border border-zinc-900 bg-zinc-900/40 backdrop-blur-md rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 flex-1 text-center md:text-left">
              ...
              <p className="text-zinc-400 text-sm md:text-base max-w-lg mb-6 leading-relaxed">
                Faça seus palpites sobre quem se classificará na fase de grupos
                e projete o mata-mata completo do maior torneio do planeta.
                Dispute prêmios com a galera!
              </p>
            ...
            <div className="relative z-10 w-full md:w-auto flex flex-col items-center justify-center bg-zinc-950/50 border border-zinc-800/80 p-6 rounded-2xl md:min-w-[320px]">
              ...
              <h3 className="font-bold text-lg text-zinc-200">
                Palpite nos Grupos & Cup
              </h3>
              <p className="text-zinc-500 text-xs text-center mt-1 mb-4 max-w-[200px]">
                A pontuação se ajusta de acordo com o nível de acerto nos jogos
                e mata-mata.
              </p>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-zinc-500 text-xs mt-0.5">
                    Participe, crie novos grupos e acompanhe os encerramentos.
                  </p>
                </div>
                <Button
                  onPress={() => setIsModalOpen(true)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
                {INITIAL_POOLS.map((pool) => (
                  <Card
                    key={pool.id}
                    className="bg-zinc-900/50 border border-zinc-900 rounded-2xl hover:border-zinc-800 transition-all flex flex-col justify-between overflow-hidden group"
                  >
                    <div
                      className={`h-1.5 w-full bg-gradient-to-r ${pool.gradient}`}
                    />
                        ...
                        <div className="space-y-1.5">
                          ...
                          >
                            <ProgressBar.Track className="bg-zinc-950 h-1.5 rounded-full overflow-hidden">
                              <ProgressBar.Fill
                                className={`h-full rounded-full bg-gradient-to-r ${pool.gradient}`}
                              />
                            </ProgressBar.Track>
                          </ProgressBar>
                        </div>
            ...
            <div className="flex flex-col gap-6 max-w-4xl mx-auto">
              <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-zinc-500 text-xs mt-0.5">
                    Insira os placares abaixo e clique em salvar para registrar
                    sua aposta.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <Chip
                    color="success"
                    className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs px-2 h-6"
                  >
              ...
              <div className="flex flex-col gap-4">
                {matches.map((match) => (
                  <Card
                    key={match.id}
                    className="bg-zinc-900/40 border border-zinc-900 rounded-2xl p-5 md:p-6 hover:border-zinc-800 transition-all"
                  >
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
                      ...
                      <div className="flex items-center justify-center gap-4 md:gap-8 flex-1 w-full max-w-md">
                        ...
                        <div className="flex items-center justify-end gap-3 flex-1">
                          <span className="font-bold text-sm md:text-base text-zinc-200 text-right line-clamp-1">
                            {match.home}
                          </span>
                        ...
                        <div className="flex items-center gap-1.5 bg-zinc-950 border border-zinc-800 px-2 py-1.5 rounded-xl shrink-0">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleScoreInput(match.id, "home", e.target.value)
                            }
                        ...
                        <span className="text-zinc-600 font-extrabold text-sm shrink-0">
                          X
                        </span>
                        ...
                        <div className="flex items-center gap-1.5 bg-zinc-950 border border-zinc-800 px-2 py-1.5 rounded-xl shrink-0">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleScoreInput(match.id, "away", e.target.value)
                            }
                            className="w-8 text-center font-bold text-zinc-100 text-base md:text-lg focus:outline-none bg-transparent"
                        ...
                        <div className="flex items-center justify-start gap-3 flex-1">
                          ...
                          <span className="font-bold text-sm md:text-base text-zinc-200 text-left line-clamp-1">
                            {match.away}
                          </span>
                        </div>
                      </div>
          ...
          <Tabs.Panel id="leaderboard" className="pt-2">
            <div className="flex flex-col gap-4 max-w-4xl mx-auto">
              <div>
                ...
                <p className="text-zinc-500 text-xs mt-0.5">
                  Acompanhe quem está no topo e quem está subindo no placar
                  geral do bolão.
                </p>
              </div>
                  ...
                  <Table.ScrollContainer>
                    ...
                    >
                      <Table.Header className="bg-zinc-900/50 text-zinc-400 border-b border-zinc-850 text-xs font-bold uppercase tracking-wider">
                        ...
                        <Table.Column className="text-center py-4">
                          Placar Exato (10pt)
                        </Table.Column>
                        <Table.Column className="text-center py-4">
                          Vencedor/Gols (5pt)
                      ...
                      <Table.Body className="text-sm font-semibold text-zinc-200">
                        {LEADERBOARD.map((user) => (
                          ...
                          >
                            ...
                            <Table.Cell className="text-center py-4 text-zinc-400">
                              {user.exact}
                            </Table.Cell>
                            <Table.Cell className="text-center py-4 text-zinc-400">
                              {user.outcome}
          ...
          <Tabs.Panel id="rules" className="pt-2">
            <div className="flex flex-col gap-4 max-w-3xl mx-auto">
              <div>
                ...
                <p className="text-zinc-500 text-xs mt-0.5">
                  As regras definem o número de pontos somados por partida
                  dependendo da precisão de seu palpite.
                </p>
              </div>
                ...
                <Accordion className="w-full">
                  <Accordion.Item>
                    ...
                    <Accordion.Panel className="pb-4 pt-1 pl-7 text-xs text-zinc-400 leading-relaxed">
                      <Accordion.Body>
                        Você ganha <strong>10 pontos</strong> se acertar
                        exatamente o resultado final do jogo. Por exemplo, se
                        você palpitou 2 x 1 e a partida terminou exatamente 2 x
                        1.
                      </Accordion.Body>
                    </Accordion.Panel>
                  </Accordion.Item>
                  ...
                  <Accordion.Item>
                    <Accordion.Heading>
                      <Accordion.Trigger className="text-sm font-semibold py-3 flex items-center justify-between text-zinc-200 hover:text-emerald-400 w-full text-left">
                        <span className="flex items-center gap-2">
                          <span className="text-emerald-550">⚽</span>
                          <span>
                            Acerto de Vencedor & Gols do Vencedor (7 Pontos)
                          </span>
                        </span>
                        <Accordion.Indicator>
                          <span className="text-xs text-zinc-600">▼</span>
                    ...
                    <Accordion.Panel className="pb-4 pt-1 pl-7 text-xs text-zinc-400 leading-relaxed">
                      <Accordion.Body>
                        Você ganha <strong>7 pontos</strong> se acertar o
                        vencedor da partida e o número exato de gols marcados
                        pelo time vencedor, mesmo errando o saldo ou gols do
                        perdedor. Por exemplo, palpitou 3 x 1 e terminou 3 x 2.
                      </Accordion.Body>
                    </Accordion.Panel>
                  </Accordion.Item>
                  ...
                  <Accordion.Item>
                    ...
                    <Accordion.Panel className="pb-4 pt-1 pl-7 text-xs text-zinc-400 leading-relaxed">
                      <Accordion.Body>
                        Você ganha <strong>5 pontos</strong> se acertar o
                        vencedor e a diferença de gols (saldo). Por exemplo,
                        palpitou 2 x 0 (saldo +2) e terminou 3 x 1 (saldo +2).
                      </Accordion.Body>
                    </Accordion.Panel>
                  </Accordion.Item>
                  ...
                  <Accordion.Item>
                    ...
                    <Accordion.Panel className="pb-4 pt-1 pl-7 text-xs text-zinc-400 leading-relaxed">
                      <Accordion.Body>
                        Você ganha <strong>3 pontos</strong> se apenas acertar
                        quem ganhou o jogo (ou o empate), mas errar placar
                        exato, gols do vencedor e saldo.
                      </Accordion.Body>
                    </Accordion.Panel>
                  </Accordion.Item>
                </Accordion>
        ...
        <Modal.Container>
          <Modal.Dialog className="bg-zinc-900 border border-zinc-800 rounded-3xl w-full max-w-md p-6 relative">
            ...
            <Modal.Header className="mb-4">
              ...
              <Modal.Heading className="text-xl font-bold text-zinc-100">
                Criar Novo Bolão
              </Modal.Heading>
            </Modal.Header>
            ...
            <form onSubmit={handleCreatePool}>
              <Modal.Body className="space-y-4 py-2">
                ...
                <div className="bg-zinc-950/40 p-4 rounded-xl border border-zinc-900 text-xs text-zinc-500 leading-relaxed">
                  Ao criar o bolão, você se tornará o{" "}
                  <strong>administrador</strong>. Poderá definir taxas de
                  entrada se desejar e convidar amigos pelo link gerado.
                </div>
              </Modal.Body>
      ...
      <footer className="w-full border-t border-zinc-900 bg-zinc-950 py-8 text-center text-zinc-600 text-xs mt-auto">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>
            © {new Date().getFullYear()} Bolão Maia. Todos os direitos
            reservados.
          </p>
