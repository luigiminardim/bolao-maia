    ...
    <main className="container mx-auto px-4 py-10 flex-1 flex flex-col max-w-3xl">
      ...
      <div className="relative overflow-hidden bg-zinc-900/30 border border-zinc-900 rounded-3xl p-8 md:p-12 mb-10 shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-xl">
            ...
            posição, mais pontos valem os palpites que o previram corretamente.
          </p>
        </div>
      </div>
      ...
      <section className="mb-14">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          Cada grupo tem <strong className="text-zinc-200">4 times</strong>. Os{" "}
          <strong className="text-zinc-200">2 primeiros</strong> de cada grupo
          se classificam automaticamente. Os{" "}
          <strong className="text-zinc-200">
            8 melhores terceiros colocados
          </strong>{" "}
          (de um total de 12) também avançam, completando os 32 classificados. A
          pontuação de cada time é{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <ExampleCard
            ...
            rows={[
              ...
              {
                label: "Portugal — palpite era classificado, ficou 4º no grupo",
                pts: "0 pts",
              },
            ]}
            total={0}
      ...
      <section className="mb-14">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          <strong className="text-zinc-200">32 classificados</strong> da fase de
          grupos. O palpite indica até qual fase você prevê que cada time
        ...
        <p className="text-xs text-zinc-600 mb-6">
          = {CUP_CHAMPION} (campeão) + {CUP_FINALIST} (finalista) + {CUP_THIRD}{" "}
          (3º) + {CUP_FOURTH} (4º) + 4 × {CUP_QUARTERS} (quartas) + 8 ×{" "}
          {CUP_ROUND16} (oitavas) = {MAX_CUP} pts
        </p>
      ...
      <section className="mb-14">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          A pontuação geral é a <strong className="text-zinc-200">soma</strong>{" "}
          dos pontos obtidos na fase de grupos e na fase de mata-mata.
        </p>
          ...
          {[
            {
              ...
              body: (
                <>
                  ...
                  classificados). A posição de cada time é determinada pela fase
                  em que foi eliminado:
            ...
            },
            {
              ...
              body: (
                <>
                  A pontuação bruta é a probabilidade <em>inversa</em> — eventos
                  mais raros geram valores maiores:
                  <FormulaBlock>
            ...
            },
            {
              ...
              body: (
                <>
                  O fator <code className="text-emerald-300">k</code> multiplica
                  a pontuação para diferenciar as fases do torneio. A pontuação
                  final é:
                  <FormulaBlock>
                    ...
                    <span className="text-zinc-300">(pos_real, palpite)))</span>
                    <br />
                    <br />
                    <span className="text-zinc-600">
                      {"// k = 1  → fase de grupos"}
