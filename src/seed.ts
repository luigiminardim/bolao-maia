...
async function seed() {
  ...
  const worldCup2026GroupList = new GroupListChampionship(
    ...
    [
      ...
      new GroupListGroupChampionship("C", [scotland, morocco, brazil, haiti]),
      new GroupListGroupChampionship("D", [usa, australia, turkiye, paraguay]),
      ...
      new GroupListGroupChampionship("G", [newZealand, iran, belgium, egypt]),
      ...
      new GroupListGroupChampionship("I", [france, senegal, iraq, norway]),
    ...
    [netherlands, brazil, belgium, qatar, spain, austria, uzbekistan, iraq],
    2,
